...
```bash
git clone https://github.com/tetrashop/Persian-Text-Analyzer.git
cd Persian-Text-Analyzer
...
- **URL:** [  🚀 دیپلوی Persian-Text-Analyzer روی Vercel...
    ❌ دیپلوی ناموفق!
...
Vercel CLI 58.5.1 (Node.js 26.4.0)
  ...
  Directory       ~/github/Persian-Text-Analyzer
...
Learn More: https://vercel.com/docs/projects/overview#project-name](  🚀 دیپلوی Persian-Text-Analyzer روی Vercel...
    ❌ دیپلوی ناموفق!
error: "/data/data/com.termux/files/usr/lib/node_modules/vercel/dist/get-latest-worker.cjs" has bad ELF magic: 2f2a2a0a
Vercel CLI 58.5.1 (Node.js 26.4.0)
...
- **وضعیت:** ✅ فعال
- **آخرین به‌روزرسانی:** 2026-08-15 18:11
